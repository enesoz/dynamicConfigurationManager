...
public class ConfigurationController {
	...
	public String index(Map<String, Object> model) {
		model.put("config", ConfigurationEntity.createEmptyConfigurationEntity());
		model.put("configEntities", service.getConfigurations());
		return "index";
	}

	/**
	 * Not using while last modifications
	 * 
	 * @param model
	 * @return
	 */
	...
	public String addStudent(Model model) {
		model.addAttribute("config", ConfigurationEntity.createEmptyConfigurationEntity());
	 ...
	 */
	@Deprecated
	@PostMapping("addConfiguration/notused")
